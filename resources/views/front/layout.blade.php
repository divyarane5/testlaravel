            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>+91 8779608782</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  @else
                    <li><a href="{{url('registration')}}">Register now!</a></li>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  ...
                  <ul class="aa-footer-nav">
                    ...
                    <li><a href="{{url('/category/ganesh-idols')}}">Our Products</a></li>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      <p>Mulund East</p>
                      <p><span class="fa fa-phone"></span>+91 83838383838</p>
